...
<form:form method="POST" commandName="userCommandName" action="/userLogon">

    <%--в форму передали объект User при помощи commandName. path должны азываться также, как и поля класса User--%>
